<tr class="hover:bg-gray-50">
    ...
    <td class="px-6 py-4 text-center">
        <a href="{{ route('products.show', $p->id) }}"
           class="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium rounded-lg shadow-md">
            Voir
        </a>
    </td>
    ...
    <td class="px-6 py-4 text-center">
        <a href="{{ route('products.edit', $p->id) }}"
           class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow-md">
            Modifier
        </a>
    </td>
